...
function BackButton() {
    return (
        <Link as={RouterLink} to="/" _hover={{ textDecoration: "none" }}>
            <Button marginTop="3" width="auto">
                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-arrow-big-left-filled" 
                    width="27" height="27" viewBox="0 0 24 24" strokeWidth="1.5" stroke="black" fill="white" 
                    ...
                    <path d="M9.586 4l-6.586 6.586a2 2 0 0 0 0 2.828l6.586 6.586a2 2 0 0 0 2.18 .434l .145 -.068a2 2 0 0 
                        ...
                        0 0 -3.414 -1.414z" strokeWidth="0" fill="#008080" />
                </svg>
                <Text ml={2} color="#008080">Back</Text>
            </Button>
        </Link>
    );
}
