            ...
            <Container bg='teal.600' borderRadius="30" w='500px' h='400px' color="white" p={5} shadow="2xl" border="2px" borderColor="gray.400">            
                <Tabs isFitted variant="soft-rounded">
                    <TabList mb="1em" border="1px" borderRadius="21px">
                        <Tab color="white" _hover={{ color: "white", bg: "teal.800"}} _active={{ transform: "translateX(10px)", transition: "transform 0.2s" }}>Login</Tab>
                        <Tab color="white" _hover={{ color: "white", bg: "teal.800"}} _active={{ transform: "translateX(10px)", transition: "transform 0.2s" }}>Sign Up</Tab>
                    </TabList>
                    <TabPanels>
                        <TabPanel>
                            <form>
