...
function Puzzles() {
    ...
    return (
        <div style={{ display: 'grid', gridTemplateColumns: 'auto auto', justifyContent: 'center', alignItems: 'center', height: '100vh', paddingBottom: '50px', position: 'relative' }}>
            <div style={{ margin: 'auto', display: 'flex', flexDirection: 'column', alignItems: 'flex-end', position: 'relative' }}>
                <CustomBoard
                    ref={customBoardRef}
                    fen={fen}
